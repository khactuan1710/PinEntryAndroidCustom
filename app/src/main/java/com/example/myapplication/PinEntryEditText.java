...
public class PinEntryEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mCirclePaint.setColor(Color.parseColor("#8a8a8a")); // Đặt màu cho dấu chấm tròn, bạn có thể thay đổi màu sắc
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mNumChars; i++) {
            ...
            if (getText().length() > i) {
                ...
                canvas.drawCircle(middle, bottom - mLineSpacing - mCharSize / 4, circleRadius, mCirclePaint);
            }
